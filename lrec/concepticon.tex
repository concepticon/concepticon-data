...
\address{ 
	       ...
	       \href{mailto:cysouw@uni-marburg.de}{cysouw@uni-marburg.de}, 
...
claimed that this
part of the lexicon, which was later called \emph{basic vocabulary}, would be very
...
\emph{purposes}. A major distinction can be made between those concept lists which have been compiled for
the
...
The purpose for which a given concept list was originally defined has an immediate influence on
its \emph{structure}. Given the multitude of use cases in both synchronic and diachronic linguistics, it is
...
The Concepticon currently\footnote{This is version 0.2 "public beta", see
\url{http://dx.doi.org/10.5281/zenodo.32001}, published at \url{http://concepticon.clld.org}.} links
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.45\textwidth]{img/child.pdf}
...
\begin{table}[h]
  ...
  \begin{figure}[h]
  \centering
  \includegraphics[width=0.45\textwidth]{img/rain.pdf}
...
concept ``dull". From the Chinese terms used in the lists by \newcite{Wang2006} and
\newcite{Chen1996}, however, we can clearly see that the intended meaning is not ``dull" in the
...
typical use case for the Concepticon: The project will publish dictionaries of lesser-described languages in a
...
\noindent The data underlying the Concepticon is curated at
\url{http://github.com/clld/concepticon-data}. The application source code for the publication of
the Concepticon can be accessed at \url{http://github.com/clld/concepticon}. The application itself
can be accessed via \url{http://concepticon.clld.org}. The most recent release of the
Concepticon can be downloaded from \url{http://dx.doi.org/10.5281/zenodo.32001}.
