...
| 5 | HAIR | 23 | 117 | «(its) hair», «(single) hair», «HAIR, (FUR)», «HAIR2, (FUR)», «HAIR», «Hair (head)», «Hair», «`*`hair (body)», «`*`hair», «hair (head)», «hair (human head)», «hair (human)», «hair (noun)», «hair (of head)», «hair (of the head)», «hair [head]», «hair [of head]», «hair on head», «hair, forehead», «hair-», «hair», «head hair», «the hair» |
| 6 | LIE (REST) | 23 | 65 | «LIE (DOWN)», «LIE», «Lie», «TO LIE (ON SIDE)», «`*`lie», «be lying down», «lie (down)», «lie (i.e. be in lying position)», «lie (recline)», «lie (v., to tell a lie)», «lie [recline]», «lie on side», «lie», «to be lying down», «to lie (as on one's side)», «to lie (down)», «to lie (on bed)», «to lie (on side)», «to lie (on the side)», «to lie (posture)», «to lie on side», «to lie, to rest (verb)», «to lie» |
| 7 | BREAST | 22 | 85 | «BREAST», «Breasts», «Breast», «`*``*`breasts», «`*`breasts», «`*`breast», «breast (chest)», «breast (chest, male & female)», «breast (female)», «breast (of woman)», «breast (woman)», «breast (woman’s)», «breast [wmn's]», «breast(s)», «breast--», «breast`*`», «breasts», «breast», «female breast», «the breast», «woman's breast», «woman’s breasts» |
...
| No. | concept set | distinct labels | concept lists | examples |
| --- | --- | --- | --- | --- |
| 1 | TOOTH | 17 | 131 | «(its) tooth», «TOOTH (FRONT)», «TOOTH», «Teeth», «Tooth», «`*`tooth», «teeth, tooth (noun)», «teeth», «the tooth», «tooth (front rather than molar)», «tooth (incisor)», «tooth (molar)», «tooth (noun)», «tooth (rather not molar)», «tooth+», «tooth`*`», «tooth» |
| 2 | WATER | 10 | 130 | «WATER», «Water», «`*`water», «the water», «water (1)», «water (2)», «water (fresh water)», «water (noun)», «water+», «water» |
| 3 | EYE | 12 | 129 | «(its) eye», «EYE», «Eyes», «Eye», «`*`eye», «eye (1)», «eye (2)», «eye (noun)», «eye`*`», «eyeball», «eye», «the eye» |
